...
FROM Casting INNER JOIN Movies ON Casting.movie_id = Movies.id 
INNER JOIN Actors ON Casting.actor_id = Actors.id
INNER JOIN Characters ON Casting.character_id = Characters.id;
